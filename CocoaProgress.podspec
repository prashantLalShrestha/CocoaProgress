Pod::Spec.new do |spec|
  spec.name = "CocoaProgress"
  spec.version = "1.0.0"
  spec.summary = "CocoaProgress is just a simple CoreFoundationKit utility Module"

  spec.description = <<-DESC
  This module contains the tab bar controller with a circular button at center
                   DESC

  spec.homepage = "https://github.com/prashantLalShrestha/CocoaProgress"
  ...
  # spec.source = { :git => '' }
  spec.source = { 
    :git => "https://github.com/prashantLalShrestha/CocoaProgress.git", :tag => spec.version.to_s
  }
